...
plasFolderNamePerClassESPRESSO_0 = f'{dataFolder}/plas/{modelName}/ESPRESSOOptimizedPerClass_0'
plasFolderNamePerClassESPRESSO_2 = f'{dataFolder}/plas/{modelName}/ESPRESSOOptimizedPerClass_2'
pruned = True
prunedBaseFilename = f'{dataFolder}/savedModels/{modelName}_prunedInfo'
...
def main(prun):
    ...
    if prun:
        ...
        fillPLAESPRESSO(plasFolderNamePerClassESPRESSO_0, 'optimizedPerClassESPRESSO_0')
        fillPLAESPRESSO(plasFolderNamePerClassESPRESSO_2, 'optimizedPerClassESPRESSO_2')
    ...
    for layer in ttSize:
        ...
        if prun: # Info between ESPRESSO and NotESPRESSOed
            ...
            infoStr.append(f'Entries spared following optimization per class: {optimizedPerClass_0EntriesSparedAbs} ({optimizedPerClass_0EntriesSparedPer:.2f}%)')
            infoStr.append(f'Entries spared following optimization per class: {optimizedPerClass_2EntriesSparedAbs} ({optimizedPerClass_2EntriesSparedPer:.2f}%)')
            infoStr = '\n'.join(infoStr)
            ...
            fig = plt.figure()
            df_sorted = df.sort_values('optimizedPerClass_0ESPRESSOGain')
            plt.bar(df.index, df_sorted['optimizedPerClass_0ESPRESSOGain'], color='b')
            ...
            fig = plt.figure()
            df_sorted = df.sort_values('optimizedPerClass_0ESPRESSOPer')
            plt.bar(df.index, df_sorted['optimizedPerClass_0ESPRESSOPer'], color='b')
            plt.title(f'% Entries spared per Neuron in {layer} (PC_0)')
            plt.xlabel('Neuron')
            plt.ylabel(f'% Entries spared')
            plt.xticks([])
            ...
            fig = plt.figure()
            df_sorted = df.sort_values('optimizedPerClass_2ESPRESSOGain')
            plt.bar(df.index, df_sorted['optimizedPerClass_2ESPRESSOGain'], color='b')
            ...
            fig = plt.figure()
            df_sorted = df.sort_values('optimizedPerClass_2ESPRESSOPer')
            plt.bar(df.index, df_sorted['optimizedPerClass_2ESPRESSOPer'], color='b')
            plt.title(f'% Entries spared per Neuron in {layer} (PC_2)')
            plt.xlabel('Neuron')
            plt.ylabel(f'% Entries spared')
            plt.xticks([])
